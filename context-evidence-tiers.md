# Evidence Tiers
## Citation Strength Requirements by Claim Type

This document defines evidence expectations for claims in the essay to maintain academic rigor and consistent sourcing.

### Tier 1: Foundational Claims (Highest)
Use peer-reviewed or foundational texts; multiple sources when possible where the claim depends on prior literature.
Applies to:
- definition and boundary claims around censorship, epistemic preference, contest, selection, and control;
- the structural shortcut claim that censorial control can stabilise an epistemic preference by changing participation conditions rather than requiring repeated epistemic contest;
...
Applies to:
- broader suggestions about why social systems in general develop shortcuts;
- comparisons between censorship and other shortcut systems such as morality or social norms;
