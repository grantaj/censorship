...
- Classification attaches to a specified relation, not to an act, actor, or institution wholesale. Fix before classification: the target contribution or participant; the field or channel in which the target participates or ordinarily could participate and through which the mechanism has practical leverage; the ordering at stake, meaning the practical ordering in that field/channel that the mechanism maintains, changes, or attempts to change; and a realistic comparator or baseline. An antecedent legal, professional, moral, or other evaluative judgment that motivates or justifies the mechanism is not substituted for that practical ordering unless it is itself the field outcome being altered. These elements should follow from the concrete mechanism and practical context, not be redrawn after the fact to obtain a preferred classification.
...
- Selectivity belongs to that mechanism or participation condition, not to the observed outcome alone. A position-linked rule can be selective in a single case; an unintended or distributed mechanism may instead be evidenced by a stable pattern, response architecture, or counterfactual asymmetry. A field-operational criterion that merely happens to correlate with a position is not enough unless the mechanism makes participation depend on that relation.
- Non-action is analysed against a field-grounded descriptive baseline, not a general duty to assist. Relevant baselines can come from an explicit decision rule, established rule, workflow, service, role, remediation or enforcement pathway, system design, or treatment of genuinely comparable cases.
...
The core discriminator is structural and relational: **does the relevant result depend on changing the target's contestability?** The relevant result is the practical ordering in the specified field/channel affected by the mechanism, not merely an antecedent judgment used to justify or trigger that mechanism.
...
1. **Dependency on altered contestability**: hold the target's contestability fixed. Would the relevant practical ordering still follow from the contest or assessment, or is altering contestability the mechanism's route to that result? Apply this to the structure of the mechanism, not merely its observed success.
2. **Selectivity**: does the participation condition or mechanism make practical treatment depend on the target's relation to the ordering under analysis? Counterfactual symmetry across genuinely comparable cases can reveal such dependence, but outcome asymmetry or correlation with a general participation criterion does not establish it.
...
- Severe or selective-looking gatekeeping is not automatically censorship; the issue is whether the practical ordering under analysis relies on changed contestability rather than merely on an adverse judgment reached within contest.
...
- **Action/non-action**: commission, omission, non-remediation, non-provision, non-enforcement, mixed. Non-action can enter the analysis only against a field-grounded descriptive baseline such as an explicit decision rule, established rule, workflow, service, role, existing response pathway, system design, or treatment of comparable cases; mere failure to help is insufficient.
...
- **Justification**: harm/safety, legal, professional/epistemic, procedural, technical, economic, moral, or other; justification does not settle structural classification.
...
1. Fix the unit of analysis: target contribution or participant; field or channel in which the target participates or ordinarily could participate and through which the mechanism has practical leverage; practical ordering in that field/channel that the mechanism maintains, changes, or attempts to change; and realistic comparator or baseline. Do not substitute an antecedent justificatory or evaluative finding for the practical ordering affected by the mechanism. Identify these from the concrete mechanism and practical context before classification, including representation, legitimacy, standing, or admissibility where relevant.
