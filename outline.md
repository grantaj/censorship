...
- Fields necessarily structure participation through remit, format, evidence, conduct, selection, ranking, jurisdiction, scarcity, and burdens of compliance. Such conditions are not censorial merely because they restrict participation or affect outcomes; administrative-burden research also shows that burdens can themselves be politically shaped. Background: `moynihanherdharvey2015`.
...
- A gate can itself be part of the contest when its independently identifiable function is to assess the target on criteria by which the ordering is ordinarily decided; it is not a shortcut merely because contest occurs at a gate. Scientific gatekeeping makes the tension explicit: exclusion can protect inquiry, while overly restrictive gatekeeping can prevent disagreement from entering and distort the consensus that follows. Support: `dormandygrimley2024`, `hauswald2026`.
...
- Jurisdictional disputes illustrate the distinction rather than solve it. Contest over venue can itself be ordinary strategic contest even where one arena advantages one side; the concern for this account arises where control over the arena changes who or what can meaningfully participate, or what the arena can practically decide, so that work on the ordering is accomplished through control of the forum rather than the contest conducted within it.
...
- How does the disputed operation alter the target's participation: does it organise, route, or conduct contest, or take over work on the ordering that would otherwise remain open within it?
...
- **Transformation** alters the version through which a target participates, including editing, translation, redaction, classification, framing, or substitution. Ordinary transformation is not self-classifying; the structural question remains whether it selectively changes participation in the ordering. Support: `zheng2024`.
...
- **Anticipatory restraint and self-censorship** are possible responses to ambient participation conditions, not separate censorial criteria. Expected criticism or disagreement can be ordinary contest; the explanatory object is the surrounding condition that changes the cost or possibility of participation. Support: `weeks2024`, `yuenlee2025`, `kuran1995`, `wangmayer2023`.
...
- Scientific gatekeeping also shows why exclusion alone is insufficient: a field must exclude fraud, bad science, or pseudoscience while retaining disagreement on which inquiry depends; overly restrictive gatekeeping can instead generate premature or distorted consensus by keeping alternatives or objections from serious consideration. Support: `dormandygrimley2024`, `hauswald2026`.
