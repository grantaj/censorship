...
- Bourdieu is a direct antecedent to the field- and participation-based perspective: in "Censorship and the Imposition of Form," field structure governs both access to expression and expressive form through its sanctions. The present account does not treat field structuration, sanction, or unequal access as censorship by themselves; it asks whether participation conditions selectively do material work that would otherwise be done through an independently specified contest/assessment. Support: `bourdieu1991`, pp. 137--159; `bunn2015`.
- Demarcation problem: once censorship is broadened beyond identifiable prohibitions, mere restriction or structuring of communicative possibility cannot by itself distinguish censorship from communication, selection, or social organisation. Schauer makes the ontological version explicit; Moore identifies the corresponding pressure in Bourdieu's model, where structural censorship risks becoming too expansive by collapsing the conditions of speech into censorship; Butler, Müller, Freshwater, and Bunn trace the wider regulatory/constitutive dispute; De Baets still presents it explicitly as a demarcation debate in 2026. Support: `schauer1998`, `moore2013`, `butler1998`, `muller2004`, `freshwater2004`, `bunn2015`, `debaets2026`.
...
- Novelty claim is explanatory and demarcational, not the discovery that censorship can be structural, field-mediated, or capable of short-circuiting inquiry.
...
- Analytic discipline: identify the field, practical ordering, ordinary contest/assessment by which that ordering is exposed to change, and the criteria relevant within that contest independently of the disputed intervention. If these can be identified only by reference to the alleged censorship, the shortcut description is circular.
- **Contest-relevant criteria**: independently specifiable standards through which the ordinary contest/assessment bears on the ordering, such as evidential adequacy in science, fidelity in translation, or query relevance in search. A label such as relevance, quality, evidence, or conduct does not establish neutrality by itself; the criterion's actual function in the field matters.
- **Ordering-relative position**: the target's standing within the specified ordering, or the substantive bearing its contribution would have on preserving, challenging, displacing, or otherwise changing that ordering if considered. It is analytically distinct from how the target/contribution fares under contest-relevant criteria; where that distinction cannot be made in a case, selectivity cannot be established by counterfactual symmetry alone.
...
- A process deciding whether participation should be restricted is not, merely by occurring, the contest the target would otherwise enter; antecedent justification matters where it engages the contribution within the same practical ordering.
- The analysis is relation-specific: a single event may contain different relations for different participants or at different stages.
...
- **Selectivity**: among targets/contributions otherwise comparable under independently specified contest-relevant criteria, the participation condition varies with ordering-relative position. An explicit position-linked rule may make this obvious; distributed or unintended cases may require stable pattern, response architecture, comparators, or counterfactual asymmetry. Outcome disparity/correlation alone is insufficient.
- **Counterfactual symmetry**: ask whether a target/contribution comparable under the independently specified contest-relevant criteria but differently related to the ordering would face the same participation condition. Asymmetry is evidence of selectivity; facially uniform application does not establish neutrality if the criterion's actual operation tracks ordering-relative position rather than the contest-relevant criterion it invokes.
- Where contest-relevant criteria and ordering-relative position cannot be independently separated well enough to construct a credible comparator, the symmetry test is unavailable and the case remains underdetermined rather than being resolved by definition.
- Content sensitivity alone is not position selectivity: relevance, scope, format, evidence, and conduct can structure participation where their relation to the ordinary contest/assessment is independently specified. Nominal invocation of such a criterion does not settle the issue if its actual operation tracks ordering-relative position.
...
Support: demarcation/structural boundary `schauer1998`, `bourdieu1991`, `moore2013`, `butler1998`, `steward2014`, `muller2004`, `freshwater2004`, `bunn2015`, `debaets2026`; selection boundary `asheim1953`, `kidd2009`; non-overt power background `lukes2005`, `foucault1977`.

## 2.3 Questions for analysis

- **Field and contest:** what target, field/channel, practical ordering, ordinary contest/assessment, contest-relevant criteria, and realistic baseline are involved? These should be identifiable independently of the disputed intervention.
...
- **Selectivity:** after accounting for independently specified contest-relevant criteria, does the alteration track ordering-relative position? Counterfactual symmetry, substitutes, leverage, decision records, stable patterns, and comparable cases may help; where criteria and position are entangled, what evidence permits them to be distinguished?
...
- The contrast establishes the basic shortcut intuition without making peer review itself presumptively censorial. A harder version remains where methodological standards are themselves disputed: the relevant criteria must be independently specified and evidence must distinguish their application from conformity with incumbent ordering as a participation condition.
...
- The relevant contest, ordering, and contest-relevant criteria must be independently specifiable; not every restriction on participation or content-sensitive criterion amounts to shortcutting contest.
- Where contest-relevant criteria and ordering-relative position cannot be independently distinguished, selectivity may remain underdetermined; the framework should not resolve that ambiguity by definition.
