...
- A gate can itself be part of the contest when its independently identifiable function is to assess the target on criteria by which the ordering is ordinarily decided; it is not a shortcut merely because contest occurs at a gate.
