...
- Gatekeeping literature supplies a complementary boundary problem: exclusion can be necessary to preserve a field's epistemic function, yet overly restrictive gatekeeping can distort the disagreement and consensus through which standing is produced. Support: `dormandygrimley2024`, `hauswald2026`.
...
- Formal burdens are likewise not self-classifying: compliance, learning, and psychological costs can be consequential features of institutional participation, and their distribution can itself be politically shaped, without burden alone establishing a censorial relation. Background: `moynihanherdharvey2015`.
...
- A gate can itself be part of the contest when its independently identifiable function is to assess the target on criteria by which the ordering is ordinarily decided; it is not a shortcut merely because contest occurs at a gate. Scientific gatekeeping makes this tension explicit: exclusion can protect inquiry, while overly restrictive gatekeeping can prevent worthwhile disagreement from entering the process and distort the consensus that follows. Support: `dormandygrimley2024`, `hauswald2026`.
- Jurisdiction allocates contest among arenas, but relocation is not neutral by definition. Arenas can differ in membership, competence, rules, burdens, remedies, and authority; venue choice can therefore confer strategic advantage while remaining part of ordinary contest. Support: `pralle2003`.
- Boundaries can also be actively drawn and redrawn in ways that allocate authority, resources, or membership, so institutional descriptions of scope cannot be assumed to be neutral facts about an arena. Background: `gieryn1983`.
...
- Jurisdictional disputes illustrate the distinction rather than solve it. Contest over venue can itself be ordinary strategic contest even where one arena advantages one side; the censorial question becomes salient where control over the arena changes who or what can meaningfully participate, or what the arena can practically decide, so that ordering-relevant work is accomplished through control of the forum rather than the contest conducted within it. Support/background: `pralle2003`, `gieryn1983`.
...
- Where arena or jurisdiction matters, what changes with the forum -- membership, competence, rules, burdens, remedies, or authority -- and is the venue dispute part of contest or a condition that displaces some of it?
...
- **Jurisdiction and venue:** arena choice can change strategic prospects without shortcutting contest. Venue shopping can be part of ordinary political contest, and boundaries can themselves be actively constructed; relocation therefore establishes neither censorship nor its absence. The explanatory issue is whether forum control still leaves substantive contest meaningfully available or instead changes who or what can participate, or what can be decided, so that the arena itself performs ordering-relevant work. Support: `pralle2003`; background `gieryn1983`.
