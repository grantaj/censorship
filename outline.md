...
- Jurisdictional disputes illustrate the distinction rather than solve it. Contest over venue can itself be ordinary strategic contest even where one arena advantages one side; the concern for this account arises where control over the arena changes who or what can meaningfully participate, or what the arena can practically decide, so that ordering-relevant work is accomplished through control of the forum rather than the contest conducted within it.
