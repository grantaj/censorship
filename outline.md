...
- Shortcut relation is a framework claim; sedimentation, position-dependent visibility, declining overt enforcement, and degraded epistemic discrimination are possible consequences, not empirical universals.
- Reduced overt enforcement does not establish consent, legitimacy, truth, or neutrality.
- Position-dependent visibility does not make classification merely subjective.
...
- **Epistemic preference**: preferred ordering of claims, topics, representations, or speakers by credibility, legitimacy, admissibility, or entitlement to consideration; need not install a counter-belief; may concern whether a rival gains enough standing or salience to matter.
...
- **Epistemic shortcut**: censorial control stabilises an epistemic preference through changed participation conditions, reducing the extent to which that preference must be repeatedly established through epistemic contest.
...
- **Operational family**: recurring kind of censorial operation at a common abstraction level.
- **Descriptive dimension**: contextual feature describing an operation without becoming another operational family.
- **Infrastructural censorship**: censorial operation embedded in ordinary rules, classifications, incentives, technical systems, rankings, professional routines, archives, or anticipatory behaviour rather than primarily exceptional prohibition.

## Source discipline

- Prior-literature, empirical, historical, and attributed claims require verified support appropriate to the claim.
- Framework-specific proposals remain visibly authored proposals. Background sources must not be made to establish the exact five-family taxonomy, shortcut formulation, sedimentation account, position-dependent visibility claim, declining enforcement burden, or stronger discrimination claim unless they actually do so.
- Hypothetical boundary cases need no citation unless empirical details about a real institution or case are introduced.
- Interpretive extensions remain qualified as possibilities unless stronger evidence is supplied.
- Citations remain attached to supported claims; bibliographic details verified before release.
...
- Position against censorship scholarship without claiming novelty for indirect, informal, infrastructural, or self-censoring forms as such.

## Argument

- Explicit prohibition important but non-exhaustive; scholarship already recognises friction, flooding, restricted access, self-censorship, and contested selection.
- Library selection debate: scarcity requires selection; selection alone does not settle ordinary selection versus censorship.
- Digital censorship: access costs, diversion, burial, and flooding without literal unavailability.
...
- Moralised usage can relabel similar selection as censorship or moderation/curation/professionalism/safety/quality control/governance according to approval.
...
3. Identify the shortcut relation: changed participation conditions can stabilise an epistemic preference without continual contest.
4. Develop sedimentation and reduced overt-enforcement consequences of the shortcut relation.
5. Group censorial operations into a small mechanism-level family taxonomy.
6. Separate operational families from subtypes, strategies, responses, and descriptive dimensions.
7. Preserve difficult selection and gatekeeping cases as tests rather than defining them away.
...
- Include indirect and infrastructural forms while preserving the boundary with selection, gatekeeping, curation, and ordinary epistemic contest.
...
- Success not required; attempted intervention may be censorial despite continuing access or failure to achieve the preferred ordering.

## 2.1 Contest and control as ideal types

- **Contest**: reasons, evidence, interpretation, criticism, rebuttal, comparison within an existing field of participation.
- **Control**: changes to practical participation conditions.
- Real interventions may combine both.
...
4. **Relation to epistemic preference**: pattern/function advances or stabilises a preferred ordering; preference may be explicit, implicit, institutional, emergent, or contested; conscious censorial intent not required.
...
- Clear prohibition/deliberate erasure: stronger censorial character.
- Routine selection under genuine constraints: may have weaker or no censorial character.
- Many cases remain intermediate; preserve grounds of disagreement rather than force a context-free verdict.

## 2.3 Censorship as epistemic shortcut

- Contest leaves a preferred ordering exposed to challenge.
- Censorial control changes participation conditions and may thereby stabilise a preferred ordering without repeatedly prevailing through contest.
- Shortcut may be partial, resisted, unsuccessful, or coexist with continuing argument.
- Descriptive claim only: no implication by itself about truth, falsity, legitimacy, illegitimacy, efficiency, or conscious design.
...
- Classify by effects on participation, not actor, intention, scale, justification, or moral evaluation.
- Operations may be partial, probabilistic, temporary, infrastructural, overlapping, or composed.

## 3.1 Exclusion

- **Prevention**: blocks expression, publication, acquisition, access, or entry before occurrence.
- **Erasure**: removes existing expression, records, traces, access, or recognised standing.

## 3.2 Attenuation

Target remains nominally present; practical access/reach/timeliness/discoverability/persistence/audience reduced.

- **Demotion/suppression**: reduced ranking, reach, recommendation, discoverability, circulation, or persistence.
- **Friction/delay**: increased time, effort, expertise, cost, or delay required for encounter/use.
- **Containment**: confinement to bounded, marginal, specialised, age-gated, jurisdiction-limited, or otherwise low-reach spaces.

## 3.3 Transformation

What is available or represented changes.

- **Modification**: changes content, framing, metadata, translation, redaction, classification, or representation while retaining continuity with an original.
- **Substitution**: replaces contested expression/account/framing/representation/record with a preferred alternative.
- May compose with exclusion or attenuation.

## 3.4 Saturation / flooding

- Surrounding information environment makes target harder to find, attend to, distinguish, verify, or use without removal.
...
- Five families are analytic proposals, not natural kinds.
- Refine subtypes without multiplying primary families unnecessarily.
- Recurring poor fits count as evidence for revision.
...
- Describe context without turning actors, justifications, or effects into operational categories.
- Dimensions analytically separable; no claim of mathematical orthogonality or statistical independence.

## Dimensions

- **Scale**: individual; group/community; institutional; national; transnational/platform-scale. Affects reach, alternatives, reversibility; does not define operation.
- **Power and channel control**: diffuse/majoritarian; concentrated institutional; elite minority; economic; technical/algorithmic; mixed/distributed. Key questions: control of consequential channel/resource; substitutability.
- **Participation in preference formation**: broad; limited; imposed; unclear/inherited/emergent. Descriptive, not general legitimacy test.
- **Persistence and revisability**: one-off/temporary; recurrent; persistent; entrenched/infrastructural. Key question: practical ability to reopen rule/ranking/classification/norm/settlement. Historical persistence may encode an earlier contest.
- **Visibility / opacity**: overt; implicit; opaque; indirectly inferable. Visibility concerns mechanism, not target. May be position-dependent: same settlement can appear as ordinary procedure/quality control/safety/professionalism/common sense to advantaged positions and as exclusion/control to disadvantaged positions; asymmetry does not make classification subjective.
- **Justification regime**: moral/harm; legal/rights; safety/risk; professional/epistemic quality; technical/efficiency; economic/market; procedural/neutrality. Sincerity does not determine structural classification.
- **Control surface / domain**: availability/access; circulation/distribution; timing; visibility/ranking/attention; legibility/classification; standing/admissibility; memory/archive. Multiple surfaces may be affected.
...
- Develop persistence consequences of the shortcut relation without restating its basic argument.
...
- Earlier contest may persist as rule, classification, ranking, professional convention, archive practice, or norm after originating actors/arguments recede.
...
- Shortcut not inherently irrational, illegitimate, false, or harmful.
- Rule/classification/convention/selection not automatically censorship.
- No claim that censorship exists because continuous deliberation is impossible.
- Inheritance/sedimentation alone does not establish censorial character; boundary factors still apply.
- Revisability/enforcement burden are not legitimacy tests.
- No dependence on morality/censorship homology, cybernetic control model, or general theory of social shortcuts.
...
- Stress-test unstable categorical boundaries; distinguish structural classification from later evaluation.

## 6.1 Classification sequence

1. Identify relevant epistemic preference without pretending certainty.
...
4. Apply boundary factors; preserve ambiguity where warranted.
5. Identify operational family/families and materially useful descriptive dimensions.
6. Test shortcut, persistence, inherited settlement, revisability, positional visibility, and reproduction mechanism where relevant; do not infer consent from low overt enforcement.
7. Move only then to normative, legal, professional, political, or practical evaluation.
...
- No quantitative censoriality score.
- Boundary cases may lack a unique correct classification.
...
- Does not subsume propaganda, persuasion, education, curation, moderation, or criticism wholesale into censorship.
- Does not assume scarcity, institutional constraints, or selection criteria are neutral.
- Inheritance, low enforcement burden, or position-dependent experience do not independently establish censorship, legitimacy, or subjectivity.
- Not all social coordination is shortcutting; not all shortcutting is censorship.
- Taxonomy remains open to empirical revision.
